...
class Forecaster:
    """A wrapper class for the SimpleFeedForward Forecaster.

    This class provides a consistent interface that can be used with other
    Forecaster models.
    """

    model_name = "SimpleFeedForward Forecaster"
    ...
    def __init__(
        ...
        hidden_dimensions: Optional[List[int]] = [20, 20],
        lr: float = 1e-3,
        ...
        """Construct a new SimpleFeedForward Forecaster
        ...
        Args:
            ...
            hidden_dimensions (Optional[List[int]]): Size of hidden layers in the feed-forward network.
    ...
    def fit(
        ...
        A separate SimpleFeedForward model is fit to each series that is contained
        in the data.
